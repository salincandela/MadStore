...
/**
 * Spring-based <code>FactoryBean</code> for obtaining the local address of this machine out of the
 * {@link it.pronetics.madstore.common.configuration.spring.MadStoreConfigurationBean} configuration.
 *
 * @author Sergio Bossa
 */
public class GridGainLocalAddressFactoryBean extends AbstractMadStoreConfigurationFactoryBean {
    ...
    public Object getObject() throws Exception {
        ...
        if (madstoreConfiguration.isGridModeEnabled()) {
            return madstoreConfiguration.getGridConfiguration().getLocalAddress();
        } else {
            return "";
        }
    }
