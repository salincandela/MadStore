...
/**
 * Spring-based <code>FactoryBean</code> for obtaining the jcr repository password out of the
 * {@link it.pronetics.madstore.common.configuration.spring.MadStoreConfigurationBean} configuration.
 *
 * @author Salvatore Incandela
 */
public class PasswordFactoryBean extends AbstractMadStoreConfigurationFactoryBean {

    public Object getObject() throws Exception {
        MadStoreConfigurationBean madstoreConfiguration = getMadStoreConfiguration();
        return madstoreConfiguration.getJcrConfiguration().getPassword();
    }
